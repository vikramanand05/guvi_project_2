...
icon = Image.open(r"D:\picture\Untitled design.png")
...
def setting_bg():
    st.markdown(f""" <style>.stApp {{
                        background:url("https://wallpapercave.com/w/Zkc7mGk");
...
if selected == "Home":
    ...
    with col1:
        st.image(Image.open(r"D:\picture\Untitled design.png"), width=500)
